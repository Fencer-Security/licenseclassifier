...
The patterns (licenses.json.gz) are built from the corpus sources in data/: most are
vendored from google/licensecheck v0.3.1 and the rest were generated from the SPDX
License List matching templates by this project, with data/order.txt recording which
is which. The compiled scanner (scanner.bin.gz) is prebuilt from the patterns by
